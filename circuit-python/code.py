...
def passwords():
    ...
    while True:  # Keep listening for button presses
        ...
        if cpx.button_a:
            ...
            passw = str(random.randint(1000, 9999))  # Or any other generation method
...
#     passws = ['1234', '1234', '1234', '1234', '1', '1ll', '1', 'q', 'u$er h4cked y0u']
...
def gradient_colors():
    for color in range(1, 255):
        if cpx.switch:
            break
        fill = colwheel(color, brightness=0.1) # colwheel needs to be coded or imported
